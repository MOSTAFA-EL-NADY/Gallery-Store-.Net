namespace Gallery.Extensions
{
    ...
    {
        public static void AddGalleryServices(this IServiceCollection services)
        {
            ...
            {
                option.SwaggerDoc("v1", new OpenApiInfo { Title = "Gallery API", Version = "v1" });
                ...
                option.AddSecurityRequirement(new OpenApiSecurityRequirement
    {
        ...
        public static void AddDbGalleryStore(this IServiceCollection services, IConfiguration configuration)
        {
